...
% \footnote{At distances greater than 15\,cm, energy incoming during
% execution is negligible and the stored energy is insufficient to complete some of the static tasks.}. 
