...
\includegraphics[width=.8\columnwidth]{figures/dif_cap}
    \caption{\add{Anatomy of \sys coalescing---A snapshot of measured data showing how \sys coalesces static tasks. \sys takes advantage of the guarantee that an energy buffer offers after a reboot: code execution resumes after energy accumulation reaches the operational threshold (a maximum threshold). Thus, \sys starts with a big coalesced task and shrinks it gradually as the risk of a power failure increases.}}
