...
\textbf{\large Additional changes}
\begin{enumerate}%
...
\response{As it is indicated in \hyperref[R1:1]{[R1:1]}, Coala addresses deficiencies in the \emph{static} task-based systems and provides a more efficient alternative. Therefore, we compared its performance against the performance of the state-of-the-art task-based runtime.}
...
\begin{editor}
\referee{}
\response{Dear editor we added a new figure to the paper, Fig. 5. The figure's sole purpose is to aid explaining the concept of \textit{task coalescing}.
We hope that this modification is approved by you.}
\end{editor}
