...
We are also grateful to the reviewers for their substantial effort spent on evaluating our work. \\
...
\response{As indicated by the reviewer, [12, 42] are not checkpoint systems. They are task-based systems and their results show that task-based systems are faster than checkpoint-based ones. Therefore, we restated their claim and provided the supporting references, which are [12, 42].\\
 Coala addresses deficiencies in the \emph{static} task-based systems and provides a more efficient alternative. Therefore, we compared its performance against the state-of-the-art task-based runtime.}
...
\response{We normalized these two special cases on 1 second. This information is added to Section 8.2; additionally, the figure reference is corrected. }
...
\begin{editor}
\referee{}
\response{We have added a new figure to the paper, i.e. Fig. 5. The figure's sole purpose is to aid in explaining the concept of \textit{task coalescing}.
