...
\begin{figure}[t]
	...
	\caption{.\todo{Explain HW/SW setup; make fonts larger, unify legends and axes.  We only need to show the right side; this figure shows that we operate out of SRAM and page to FRAM; the copying mechanism is peripheral to the main idea.}{Amjad}}
