...
\begin{table}
	...
	BioImpedance~\cite{rodriguez_tbcs_2015} & 20\,$\mu$F \\
	...
	X~\cite{nadeau_naturebio_2017}~\cite{} & X\,$mu$F\\
	\hline
	\end{tabular} 
\caption{Comparison of storage sizes for various battery-less platforms. Values for other representative platforms~\cite{medusa_farsens_2017,talla_imwut_2017,liu_sigcomm_2013,parks_sigcomm_2014} were not reported in their respective papers.}
