...
\begin{subfigure}[t]{.49\columnwidth}
	\centering \includegraphics[width=\columnwidth]{figures/fram_write.eps}
	\caption{Cost of \emph{write} operation.}
\end{subfigure}%
\begin{subfigure}[t]{.49\columnwidth}
	\centering \includegraphics[width=\columnwidth]{figures/fram_read.eps}
	\caption{Cost of \emph{read} operation.}
\end{subfigure}
	\caption{Cost of accessing volatile (SRAM)/non-volatile (FRAM) memory during write and read operation.\todo{pico jole$\rightarrow$Picojoule}{Amjad}}\label{fig:framEnergy}
\end{figure}
