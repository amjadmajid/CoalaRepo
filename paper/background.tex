...
\begin{wrapfigure}{t!}{0.5\textwidth}
	...
	\end{subfigure}
	\caption{\textbf{Code example demonstrating checkpointing gives rise to data inconsistency.}}\label{fig:code_demo_incosistency}
\end{wrapfigure}
%\end{figure}
...
Despite their advantages, the task-based programming models have their limitations. Two major ones being: {\em memory overhead} and {\em inflexibility to dynamic energy harvesting conditions}.
