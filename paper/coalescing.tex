...
last version of the page needs to be committed. \xxx{maybe is possible to
demonstrate with data? count number of executed non-volatile vs volatile accesses}
...
\xxx{Replace the following with definition of all coalescing strategies}
