...
\begin{document}
	...
	\node[punkt, right =2cm of task4] (task6) {Task (6)};	
	...
	\begin{pgfonlayer}{bg}    % select the background layer
		...
		\draw[<->] ([xshift=-1.7cm]Virtualized.north) --node[sloped, anchor=south] {Virtualization Window} ([xshift=-1.7cm]Virtualized.south);
	\end{pgfonlayer}
