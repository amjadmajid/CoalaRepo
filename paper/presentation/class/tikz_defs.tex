...
\tikzset
{
	AlertText/.style =
	{
		starburst,						% shape
		drop shadow,
		starburst points = 30,		% | shape parameters
		starburst point height = 0.4cm,	% |
		rotate			= 0,			% angle of rotation
		thick,							% thickness of the border
		fill			= tudOrange!10,		% monocolored
		text			= black,	% colour of the fonts
		draw			= tudTurquoise,			% colour of the border
		font			= \large,		% shape of the font (or dimension, like 
		%\tiny)
		text centered,					% text alignment 
	}
}
...
\tikzset
{
	WarningText/.style =
	{
		...
		scale			= 1.0,			% scaling factor
		thick,							% thickness of the border
		fill			= tudCyan!10,		% monocolored
		text			= black,	% colour of the fonts
		draw			= tudCyan,			% colour of the border
		font			= \large,		% shape of the font (or dimension, like 
		%\tiny)
		text centered,					% text alignment 
		inner xsep		= 0.4cm,		% minimum distance between text and 
		%borders along x dimension
		inner ysep		= 0.4cm			% minimum distance between text and 
		%borders along y dimension
	}
}
