...
%
Figure~\ref{fig:coalEfficiency} (top) breaks down the time spent on executing
...
%
Figure~\ref{fig:coalEfficiency} (bottom) breaks down protected memory accesses
...
%
The results in Figure~\ref{fig:coalescing} show that all benchmarks
