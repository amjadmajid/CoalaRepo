...
non-volatile memory.
% because it allows {\em writes} from a failed attempt to
...
Moreover, when \emph{heterogeneous devices} with different energy buffers (e.g., 20 \micro\farad~\cite{rodriguez_tbcs_2015} to 0.1 \farad~\cite{moo}) are considered, the problem of porting a program becomes much worse
