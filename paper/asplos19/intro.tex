...
=======
    \caption{\note{All this white padding is ugly} Task coalescing at runtime reduces time and energy overhead in task-based intermittent programming models by performing fewer commits (denoted as \texttt{C} in the figure). On the other hand, task splitting reduces wasted computation and enables termination for bigger tasks.}
>>>>>>> 0a3ae3677cf0c2d091916b767178e84f4a4752cd
    \label{fig:coalesce}
\end{figure}
%
...
=======
shows how task transitions can impose a run-time overhead. At each transition, the system incurs an overhead to track and atomically commit modifications to the non-volatile memory, to maintain consistency of program state~\cite{chain,alpaca}. The more task transitions a program requires, the more commit overhead is incurred by the system at run-time.
>>>>>>> 0a3ae3677cf0c2d091916b767178e84f4a4752cd
%
