...
large number of tasks to amortize a large amount of commit overhead. However, it must be 
{\em conservative} enough, attempting to coalesce only as many tasks as will execute
to completion given a certain energy conditions, reducing the risk or coalesced task re-execution penalty. 
