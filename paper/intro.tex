...
\begin{wrapfigure}{t!}{0.5\textwidth}
    \centering
    \includegraphics[width=0.5\textwidth]{figures/Coala_Intro_Figure.pdf}
    \caption{ %\textbf{An execution of three statically-defined tasks without (top) and with (bottom) dynamiccoalescing.}
