...
We evaluated \sys end-to-end on a real energy-harvesting device~\cite{wisp} running existing benchmarks ~\cite{chain} and new programs. A comparison to a state-of-the-art task-based system~\cite{aplaca} showed that \sys recovers
