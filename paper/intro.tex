...
We evaluated \sys end-to-end on a real energy-harvesting device~\citep{wisp} running existing benchmarks ~\citep{chain} and new programs. A comparison to a state-of-the-art task-based system~\citep{chain} showed that \sys recovers
