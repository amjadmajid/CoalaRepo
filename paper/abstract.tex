...
The Internet of Things (IoT) must be energy neutral. This can only be achieved when the batteries are removed and the energy to operate IoT comes from the ambient energy sources.
