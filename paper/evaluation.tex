...
NC: no coalescing, EB: energy-blind coalescing, HG: history-guided coalescing, WHG:
energy- and task-aware coalescing. All coalescing strategies reduce total
overhead and maximize useful work. HG and WHG perform better than EB.}
...
For each coalescing strategy from Section~\ref{sec:task_adaptation} (EB, HG,
