...
\begin{figure}
	...
	\caption{\textbf{\sys coalescing strategies performance per application on intermittent power compared to \sys without coalescing (`NO').}}
...
\begin{figure}
	...
	\caption{\textbf{\sys normalized runtime for various page sizes, \{32, 64, $\ldots$,1024\}\,bytes, per application (top) and respective page faults (bottom)}; X = zero page faults.}
