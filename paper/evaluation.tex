...
\begin{table}[t]
	...
	\begin{tabular}{l|cc|cc|cc|cc|c}
		...
		sort & 104 & 104 & 4 & 2 & 70 & 23 & 180 & & $<$1\\
		\hline
	\end{tabular}
	\caption{Comparison between compiler-generated \sys code (Comp.) and hand-written \sys code (Hand). DFT does not compile with Clang}
