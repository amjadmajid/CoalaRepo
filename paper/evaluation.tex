...
\begin{figure}
	...
	\caption{\textbf{\sys normalized runtime for various page sizes, \{32, 64, $\ldots$,1024\}\,bytes, per application (top) and respective page faults (bottom)}; X = zero page faults; the blue section of a bar represents a full page swap (replacing pages in both FRAM and SRAM).}
