...
\begin{table}[t]
	...
	\begin{tabular}{|l|cc|cc|cc|cc|c|}
		...
		\hline
	\end{tabular}
	\caption{Comparison between \sys and Chain source code line number (SLOC column) and comparison between compiler-generated \sys code (Comp.) and hand-written \sys code (Man.) (other columns). *DFT does not compile with Clang\todo{incomplete table}{Responsible:Kiwan}}
