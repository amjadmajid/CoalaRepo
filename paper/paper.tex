...
%Amjad Yousef Majid, Kas{\i}m Sinan Y{\i}ld{\i}r{\i}m, Przemys{\l}aw Pawe{\l}czak,
%TU Delft, Mekelweg\,4, 2628\,CD Delft, NL
%\{a.y.majid, k.s.yildirim, p.pawelczak\}@tudelft.nl
%
%Kiwan Maeng, Alexei Collin, Brandon Lucia
%Carnegie Mellon University, 4720 Forbes Avenue, Pittsburgh, PA 15213, USA
%\{kmaeng, acolin, blucia\}@kmaeng@andrew.cmu.edu
...
Performing complex operations on battery-less energy harvesting embedded platforms is challenging from many points of view. Here we will briefly provide a background on energy harvesting for embedded systems. 
...
Elaborating on the ``key challenge'' paragraphs near the end of the intro. We will need a picture.
