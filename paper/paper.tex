...
\input{background}
\section{\sys: Adaptive Intermittent Execution Model}
\label{sec:adaptiveExecModel}
\input{adaptiveModel.tex}

\subsection{\sys: Coalescing}
\label{sec:implementation}
\input{newCoalescing}
\input{coalescing}

\subsection{\sys: Memory Virtualization}
