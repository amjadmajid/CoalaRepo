...
coala_30  = np.array([0.788232 , 0.471374 , 0.319018 , 0.385218 ,     0    , 0.378595])
alpaca_30 = np.array([0.675560 , 1.000000 , 0.300613 , 0.552129 ,     0    , 0.715679])

coala_50  = np.array([0.858665 , 0.471374 , 0.308869 , 0.357457 ,     0    , 0.388675]) 
...
coala_30  = coala_30/alpaca_30
alpaca_30 = alpaca_30/alpaca_30


coala_50  = coala_50/alpaca_50
alpaca_50 = alpaca_50/alpaca_50
...
#     for i in range( 3 ):
#         plt.text( pos[i]+d , 0.14 , lbl[i] , fontsize=14, color='black', verticalalignment='bottom')
#     d+=1
