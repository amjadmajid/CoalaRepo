...
decomp_dma      = open('../IPOS-versions-performance/data_decompression/dma_decomp_100B.csv')
decomp_vob_ml   = open('../IPOS-versions-performance/data_decompression/vob_memLimitted_100B.csv')
decomp_vob_pl   = open('../IPOS-versions-performance/data_decompression/vob_perforLimitted_100B.csv')

sel_dma         = open('../IPOS-versions-performance/selectionSort/dma_sort_20num.csv')
sel_vob_ml      = open('../IPOS-versions-performance/selectionSort/vob_memLimitted_sort_20num.csv')
sel_vob_pl      = open('../IPOS-versions-performance/selectionSort/vob_perfLimitted_sort_20num.csv')

bd_dma         = open('../IPOS-versions-performance/largeDataCommit/DMA_commit_50B.csv')
bd_vob_ml      = open('../IPOS-versions-performance/largeDataCommit/memLimit_commit_50B.csv')
bd_vob_pl      = open('../IPOS-versions-performance/largeDataCommit/perfLimit_commit_50B.csv')
